// src/components/employee/EmployeeTopbar.js
import React, { useState } from "react";
import { Menu, Dropdown, Icon, Image } from "semantic-ui-react";
import logo from "../../assets/logo.png";
import { useNavigate } from "react-router-dom";

const EmployeeTopbar = ({ onToggleSidebar }) => {
  ...
  return (
    ...
    >
      ...
      <Menu.Item header>
        ...
        <span style={{ fontWeight: "bold", fontSize: "1.2em", color: "#6A1B9A" }}>
          Asset Hub Employee
        </span>
      </Menu.Item>
      ...
      <Menu.Menu position="right">
        ...
        >
          <Dropdown.Menu>
            <Dropdown.Item icon="user" text="Profile" onClick={() => alert("Logged in as employee@example.com")} />
